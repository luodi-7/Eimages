...
# 文件路径设置  
input_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/Eimage_final.jsonl'  
train_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotations/train_data.jsonl'  
eval_file_path = '/mnt/afs/xueyingyi/image_vague/loc_dection/Eimage_solved/annotations/eval_data.jsonl'  
